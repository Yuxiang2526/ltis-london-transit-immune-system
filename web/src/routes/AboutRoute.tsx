    ...
    <article className="about-page">
      ...
      <section className="about-section">
        <SectionHeader
          ...
          title="What this project does NOT do"
          description="The model is a deliberate simplification of the official PTAL pipeline. Where it diverges, we say so."
        />
        <ul className="about-limitations">
          <li>
            <strong>Walking-only fallback.</strong> Reachable stops are
            measured along the OSM walking network (4.8 km/h, mode-specific
            catchments of 640 m for bus and 960 m for rail). Cycling and
            micro-mobility are not modelled.
          </li>
          <li>
            <strong>No service-frequency attenuation.</strong> The route
            contribution does not penalise low-frequency or off-peak service.
            A two-bus-per-hour route counts as much as a 12-bus-per-hour route
            of equivalent geometry.
          </li>
          <li>
            <strong>No multi-modal transfers.</strong> A user walking to the
            bus, then transferring to the Underground, is not modelled. Each
            grid&rsquo;s AI is the sum of all reachable stops, regardless of
            how someone might combine them.
          </li>
          <li>
            <strong>Static service assumption.</strong> Weekend, late-night
            and peak/off-peak service variation is not modelled. Night buses
            and temporary routes are excluded outright.
          </li>
          <li>
            <strong>Indicative population, not real ONS exposure.</strong>{" "}
            Every LSOA carries a default of 1,700 people (an indicative
            proxy). Joining ONS mid-year LSOA population would convert
            indicative exposure into real "people affected" counts, but is
            not yet wired in.
          </li>
          <li>
            <strong>Three reference scenarios, not all 543 routes.</strong>{" "}
            The Story and Explorer pre-bake routes 99, R2 and 685. The
            Network Map covers the full 543-route engine; the LSOA narrative
            views are deliberately scoped down for a single editorial read.
          </li>
        </ul>
      </section>
